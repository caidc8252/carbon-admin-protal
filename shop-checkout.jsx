    ...
    <div className="tds-card">
      ...
      <div className="tds-card__body">
        {!selected ? (
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 14px', border: '1px solid var(--color-primary-700)', borderRadius: 8, background: 'var(--color-bg-2)' }}>
  ...
  <div className="tds-card">
    <div className="tds-card__header">
      <div>
        ...
        <div style={{ fontSize: 12, color: 'var(--color-text-tertiary)', marginTop: 2 }}>These are the items in your cart. Adjust quantities or remove lines before checkout.</div>
      </div>
              ...
              <div key={line.uid} className="ckw-item">
                <div className="ckw-item__img">
                  {img ? <img src={img} alt=""/>
                    ...
                    : <window.CompanyLogo name={product.name} size={46}/>}
                </div>
        ...
        <div style={{ padding: 0 }}>
          <table className="tds-table">
            ...
            <tfoot>
              ...
              <tr>
                <td colSpan="4" style={{ textAlign: 'right', fontWeight: 600, fontSize: 16, padding: '12px 14px', borderTop: '1px solid var(--color-border-subtle)' }}>Total</td>
                <td className="num" style={{ textAlign: 'right', fontWeight: 600, fontSize: 16, padding: '12px 14px', borderTop: '1px solid var(--color-border-subtle)', color: total === 0 ? 'var(--color-success-700)' : 'var(--color-text-primary)' }}>
...
.ckw-back { display: inline-flex; align-items: center; gap: 4px; background: transparent; border: 0; color: var(--color-text-secondary); font-family: inherit; font-size: 14px; cursor: pointer; padding: 0; margin: 0 0 6px; }: 4px 0; margin-bottom: 10px; }
.ckw-back:hover { color: var(--color-text-primary); }
.ckw-discount { display: flex; align-items: center; gap: 12px; flex-wrap: wrap; }
.ckw-discount__lbl { font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em; color: var(--color-text-tertiary); }
...
.ckw-discount__custom span { font-size: 12px; color: var(--color-text-tertiary); }
...
.ckw-item { display: flex; align-items: center; gap: 14px; padding: 12px 14px; background: var(--color-bg-2); border: 1px solid var(--color-border-default); border-radius: 8px; }
...
.ckw-item__name { display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 600; color: var(--color-text-primary); }
.ckw-item__name-txt { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.ckw-item__variant { font-size: 12px; color: var(--color-text-tertiary); margin-top: 3px; }
...
.ckw-item__line-total { font-size: 10px; color: var(--color-text-tertiary); text-align: right; font-variant-numeric: tabular-nums; }
