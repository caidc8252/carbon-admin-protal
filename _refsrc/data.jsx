...
const SUBSCRIBED_APPS = {
  ...
  "northbay": [
    ...
    // Catalog Sync — Northbay's own App Store has it currently UNPUBLISHED
    // (subscription.isoUnpublished = true). The publisher (Acme) is still
    // shipping the app normally; Northbay's operator paused it locally so
    // merchants in Northbay's pool can't roll the existing snapshot to new
    // terminals. Northbay can re-publish at any time from the app detail.
    { appId: "catalog",   subscribedVersionId: "v09", subscribedAt: "May 01, 2026", deployedTerminals:  18,
      isoUnpublished: true, isoUnpublishedAt: "May 18, 2026" },
