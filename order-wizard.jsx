    ...
    <div className="tds-card">
      <div className="tds-card__header">
        <div>
          ...
          <div style={{ fontSize: 12, color: 'var(--color-text-tertiary)', marginTop: 2 }}>Orders are billed and shipped to the selected customer company.</div>
        </div>
      </div>
      <div className="tds-card__body">
        ...
        <div style={{ marginTop: 14, display: 'flex', flexDirection: 'column', gap: 6, maxHeight: 280, overflow: 'auto', border: '1px solid var(--color-border-default)', borderRadius: 8, padding: 6 }}>
        ...
        {selected && (
          <div style={{ marginTop: 18, padding: 14, background: 'var(--color-bg-3)', border: '1px solid var(--color-border-subtle)', borderRadius: 8 }}>
...
const ModelGroup = ({ group, onChangeType, onRemoveType, onRemoveGroup, onPriceChange, onAddType }) => {
  ...
  const labelStyle = { fontSize: 10, fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.06em', color: 'var(--color-text-tertiary)', marginBottom: 5 };

  return (
    <div style={{ background: 'var(--color-bg-2)', border: '1px solid var(--color-border-default)', borderRadius: 8, overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', borderBottom: '1px solid var(--color-border-subtle)' }}>
        ...
        <div style={{ minWidth: 188 }}>
          <div style={{ ...labelStyle, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6 }}>
            ...
            {isOverride && (
              <button
                ...
                style={{ display: 'inline-flex', alignItems: 'center', gap: 3, padding: '1px 5px', borderRadius: 4, border: 0, background: 'transparent', color: 'var(--color-text-secondary)', cursor: 'pointer', fontSize: 10, fontWeight: 500, textTransform: 'none', letterSpacing: 0 }}>
          ...
          <div title="Shared unit price — applies to all types of this model" style={{ display: 'flex', alignItems: 'center', border: `1px solid ${isOverride ? 'var(--color-warning-500)' : 'var(--color-border-default)'}`, borderRadius: 8, background: 'var(--color-bg-2)', padding: '0 10px', height: 34 }}>
            <span style={{ fontSize: 14, color: 'var(--color-text-tertiary)', marginRight: 4 }}>$</span>
            <input
              type="text"
              inputMode="decimal"
        ...
        <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', lineHeight: 1.2, minWidth: 96 }}>
          <div style={{ fontSize: 10, fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.06em', color: 'var(--color-text-tertiary)' }}>Group total</div>
        ...
        {group.items.map((it, i) => (
          <div key={it.id} style={{
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontSize: 10, color: 'var(--color-text-tertiary)', marginTop: 1, fontVariantNumeric: 'tabular-nums' }}>
    ...
    <div className="tds-card">
      <div className="tds-card__header">
        <div>
          ...
          <div style={{ fontSize: 12, color: 'var(--color-text-tertiary)', marginTop: 2 }}>Add one or more models. An order can contain any number of model lines.</div>
        </div>
      </div>
      <div className="tds-card__body">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {items.length === 0 && (
            <div style={{ padding: '32px 20px', textAlign: 'center', color: 'var(--color-text-tertiary)', fontSize: 14, border: '1px dashed var(--color-border-default)', borderRadius: 8 }}>
        ...
        <div style={{ marginTop: items.length > 0 ? 16 : 12, padding: 12, background: 'var(--color-bg-3)', border: '1px dashed var(--color-border-default)', borderRadius: 8 }}>
...
const TypePickerModal = ({ picker, setPicker, onType, items, onConfirm }) => {
  ...
  return (
    <Modal open onClose={() => setPicker(null)}
      ...
      <div style={{ fontSize: 12, fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.07em', color: 'var(--color-text-tertiary)', marginBottom: 8 }}>
        Device type
      </div>
            ...
            <button key={t} type="button" onClick={() => onType(t)}
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)' }}>{t}</span>
                  {existQty > 0 && (
                    <span style={{
      ...
      <div style={{ marginTop: 18, display: 'flex', alignItems: 'center', gap: 16 }}>
        <div style={{ fontSize: 12, fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.07em', color: 'var(--color-text-tertiary)', flex: 'none' }}>
        ...
        <div style={{ marginLeft: 'auto', fontSize: 12, color: 'var(--color-text-secondary)', fontVariantNumeric: 'tabular-nums' }}>
          = <strong style={{ color: 'var(--color-text-primary)', fontSize: 16 }}>{moneyUSD(total)}</strong>
        </div>
      </div>
    ...
    <div className="tds-card">
      <div className="tds-card__header">
        <div>
          ...
          <div style={{ fontSize: 12, color: 'var(--color-text-tertiary)', marginTop: 2 }}>You may apply any discount from 0% up to 100% (complimentary).</div>
        </div>
      </div>
      <div className="tds-card__body">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 18 }}>
          ...
          {/* Summary */}
          <div style={{ background: 'var(--color-bg-3)', border: '1px solid var(--color-border-subtle)', borderRadius: 8, padding: 16 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              {discountPct > 0 && (
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 14, color: 'var(--color-success-700)' }}>
        ...
        <div style={{ padding: 0 }}>
          <table className="tds-table">
            ...
            <tfoot>
              ...
              <tr>
                <td colSpan="4" style={{ textAlign: 'right', fontWeight: 600, fontSize: 16 }}>Total</td>
                <td className="num" style={{ textAlign: 'right', fontWeight: 600, fontSize: 16, color: total === 0 ? 'var(--color-success-700)' : 'var(--color-text-primary)' }}>
    ...
    <div className="page">
      ...
      <div className="wizard-grid">
        ...
        <aside className="wizard-aside">
          ...
          <div style={{ marginTop: 14, padding: 10, background: 'var(--color-bg-3)', border: '1px solid var(--color-border-subtle)', borderRadius: 8, fontSize: 12, color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
