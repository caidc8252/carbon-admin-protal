    ...
    <div className="page">
      {onBack && (
        <div style={{ marginBottom: 16 }}>
          <button onClick={onBack} style={{ background: 'transparent', border: 0, padding: '6px 8px', borderRadius: 6, cursor: 'pointer', color: 'var(--color-text-secondary)', display: 'inline-flex', alignItems: 'center', gap: 4, fontFamily: 'inherit', fontSize: 14 }}>
                ...
                <tr key={o.id} onClick={() => onOpen(o.id)}>
                  ...
                  <td>
                    {o.items.slice(0, 2).map((i, idx) => {
                      ...
                      return (
                        <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12, color: 'var(--color-text-secondary)', marginBottom: idx === 0 && o.items.length > 1 ? 4 : 0 }}>
