...
//   DISTRIBUTOR — Authorized distribution partner.
//
...
const CONTRACT_TYPES = ['ADMIN', 'ISO', 'ISO-PILOT', 'ISV', 'ISV-PILOT', 'MERCHANT', 'DISTRIBUTOR'];
  ...
  },
  {
    ...
    entitlements: {
      'PAYMENT SERVICE': {
        enable: true,
        appItems: [
          { pkgName: 'com.newland.payexplorer', price: 0, currency: 'USD' },   // per device · monthly (0 = free)
        ],
      },
      'E-RECEIPT SERVICE': {
        enable: true,
  ...
  },
  {
    ...
    entitlements: {
      'PAYMENT SERVICE': {
        enable: true,
        appItems: [
          { pkgName: 'com.newland.payexplorer', price: 0, currency: 'GBP' },
        ],
      },
      'E-RECEIPT SERVICE': {
        enable: false,
  ...
  },
  {
    ...
    entitlements: {
      'PAYMENT SERVICE': {
        enable: true,
        appItems: [
          { pkgName: 'com.newland.payexplorer', price: 0, currency: 'AUD' },
        ],
      },
      'E-RECEIPT SERVICE': {
        enable: true,
  ...
  },
  {
    ...
    entitlements: {
      'PAYMENT SERVICE': {
        enable: true,
        appItems: [
          { pkgName: 'com.newland.payexplorer', price: 0, currency: 'USD' },
        ],
      },
      'E-RECEIPT SERVICE': {
        enable: true,
  ...
  },
  {
    ...
    entitlements: {
      'PAYMENT SERVICE': {
        enable: true,
        appItems: [
          { pkgName: 'com.newland.payexplorer', price: 0, currency: 'CAD' },
        ],
      },
      'E-RECEIPT SERVICE': {
        enable: true,
...
//   mfaEnable, status (ACTIVE/LOCKED/DISABLED),
...
//     DISABLED — admin-deactivated account; sign-in refused until re-enabled
//
