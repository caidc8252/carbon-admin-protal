...
const LastSeenCell = ({ ts }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 1, lineHeight: 1.25 }}>
      <span style={{ fontFamily: 'var(--font-family-mono)', fontSize: 12, color: 'var(--color-text-primary)', whiteSpace: 'nowrap' }}>{ts}</span>
      <span className="muted" style={{ fontSize: 10 }}>{_relTime(ts)}</span>
    </div>
  );
};
// ─────────────────────────────────────────────────────────────
...
const MerchantsList = ({ merchants, onOpen }) => {
  ...
  return (
    <div className="stack" style={{ gap: 14 }}>
      ...
      <window.StatGrid cols={3} style={{ marginBottom: 0 }}>
        <window.StatCard label="Merchants" value={totals.merchants} description="Under this ISO" />
        <window.StatCard label="Stores" value={totals.stores} description="Across all merchants" />
        <window.StatCard label="Active terminals" value={totals.active} description="Currently transacting" />
      </window.StatGrid>
        ...
        <table className="tds-table">
          ...
          <tbody>
            ...
            <tr key={m.id} onClick={() => onOpen(m)}>
                ...
                <td>
                  {(m.stores?.length || 0) <= 1 ?
                <span className="muted" style={{ fontSize: 12 }}>HQ only</span> :
                <span className="num" style={{ fontFamily: "var(--font-family-mono)", fontWeight: 500 }}>{m.stores.length}</span>}
                </td>
                <td>
                  <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                    <span className="num" style={{ fontFamily: "var(--font-family-mono)", fontWeight: 500, fontSize: 12 }}>{m.activeTerminalsCount || 0}</span>
                  </div>
                </td>
...
<div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
    <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
      <span className="overline" style={{ fontSize: 10, color: "var(--color-text-tertiary)" }}>
        Stores · {stores.length}
      </span>
      <span className="muted" style={{ fontSize: 12 }}>Click a card to view its terminals.</span>
    </div>
        ...
        <button key={s.id} onClick={() => onSelect(s.id)} style={{
          ...
          transition: "border-color 0.12s, background 0.12s"
            ...
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
              <div style={{ fontSize: 14, fontWeight: 600, color: "var(--color-text-primary)", lineHeight: 1.25 }}>
                {s.name}
              </div>
  ...
  return (
    <Modal open={open} onClose={onClose} width={620}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div className="muted" style={{ fontSize: 12, lineHeight: 1.5, padding: "10px 12px", background: "var(--color-bg-3)", borderRadius: 8 }}>
...
const VSSection = ({ label, rows }) => (
  <div>
    <div className="overline" style={{ fontSize: 10, color: "var(--color-text-tertiary)", marginBottom: 6 }}>{label}</div>
      ...
      <div
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
            <span style={{ fontSize: 12, color: 'var(--color-text-tertiary)', letterSpacing: '0.04em', textTransform: 'uppercase', fontWeight: 600 }}>Terminal</span>
            <span style={{ fontFamily: 'var(--font-family-mono)', fontSize: 14, fontWeight: 500, color: 'var(--color-text-primary)' }}>{sn}</span>
          </div>
          <div style={{ flex: 1 }} />
          <button
            type="button"
    ...
    <div className="info-card">
      ...
      <table className="tds-table">
          ...
          <tr key={i} style={{ cursor: "default" }}>
                ...
                <td><span style={{ fontSize: 12 }}>{t.model || <span className="muted">—</span>}</span></td>
    ...
    <div className="stack" style={{ gap: 24 }}>
      ...
      <div className="info-card" style={{ padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          ...
          <span style={{ fontSize: 14, color: "var(--color-text-primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
        ...
        <span className="muted" style={{ fontSize: 12, fontFamily: "var(--font-family-mono)" }}>{selected?.id}</span>
      </div>
          ...
          <tbody>
            ...
            return (
              ...
              <tr style={{ cursor: "pointer" }} onClick={() => toggleExpand(r.appId)}>
                  ...
                  <td>
                    <span className="num" style={{ fontFamily: "var(--font-family-mono)", fontSize: 12, fontWeight: 500 }}>{r.versionLabel}</span>
                  </td>
...
const ExpandedAppRow = ({ row, merchant }) => {
  ...
  return (
    <div style={{ padding: "14px 20px 16px 44px", display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {offTarget.length === 0 ? (
          ...
          <>
            ...
            <div style={{ padding: "10px 14px", borderBottom: "1px solid var(--color-border-subtle)" }}>
              <div className="overline" style={{ fontSize: 10, color: "var(--color-text-tertiary)", marginBottom: 4 }}>
                How they'll upgrade
              </div>
              ...
              <tbody>
                {offTarget.map(t => (
                  <tr key={t.sn} style={{ cursor: "default" }}>
                    ...
                    <td><span style={{ fontSize: 12 }}>{t.model || <span className="muted">—</span>}</span></td>
                    <td><span style={{ fontSize: 12 }}>{t.store.name}</span></td>
      ...
      {onTarget.length > 0 && (
        <div style={{ border: "1px solid var(--color-border-default)", borderRadius: 8, overflow: "hidden", background: "var(--color-bg-2)" }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "12px 14px",
        background: "var(--color-bg-3)", border: "1px solid var(--color-border-subtle)", borderRadius: 8 }}>
      ...
      {isNotSet ? (
        <div style={{ padding: "14px 16px", border: "1px dashed var(--color-border-default)", borderRadius: 8, fontSize: 14, lineHeight: 1.55, color: "var(--color-text-secondary)" }}>
        ...
        <>
          <CMField label="Timing" value={
            <div>
              <div style={{ fontSize: 14, fontWeight: 500, color: "var(--color-text-primary)" }}>{timing.label}</div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
        ...
        <div key={i} style={{ padding: "16px 20px", borderTop: i === 0 ? "0" : "1px solid var(--color-border-subtle)" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
              <div style={{ fontFamily: "var(--font-family-mono)", fontSize: 14, fontWeight: 600, color: "var(--color-text-primary)" }}>
                {c.type}
              </div>
            ...
            <div className="muted" style={{ fontSize: 12, marginTop: 6, maxWidth: 640, lineHeight: 1.5 }}>
              {c.description}
            </div>
...
<div>
    ...
    <div style={{ fontSize: 14, color: "var(--color-text-primary)", marginTop: 2 }}>{value}</div>
  </div>;


// ─── Merchant detail (read-only drill-in) ──────────────────
const MerchantViewReadonly = ({ merchant, customerName, onBack, maskOn = false, standalone = false }) => {
  ...
  const headerRow = (
        <div style={{ display: "flex", alignItems: "flex-start", gap: 14, flex: 1, minWidth: 0 }}>
          {standalone && <button type="button" className="det-back" onClick={onBack} aria-label="Back to Merchants" title="Back to Merchants" style={{ marginTop: 4 }}><Icon name="chevL" size={18} /></button>}
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ marginTop: 10, display: "flex", flexWrap: "wrap", rowGap: 6, columnGap: 18, fontSize: 12, color: "var(--color-text-secondary)" }}>
              ...
              {merchant.phone &&
              <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                  <span style={{ fontSize: 12, color: "var(--color-text-tertiary)", fontWeight: 500 }}>TEL</span>
            ...
            {merchant.notes &&
            <div className="muted" style={{ marginTop: 10, fontSize: 12, lineHeight: 1.5, maxWidth: 720 }}>
                {merchant.notes}
              </div>
            }
          </div>
    ...
    <div>
      {standalone ? (
        <div className="det-band det-band--bleed">
          <div className="det-band__inner mv-head">{headerRow}</div>
          {tabsRow}
        </div>
      ) : (
        <>
          <div className="info-card" style={{ padding: 20, marginBottom: 14 }}>{headerRow}</div>
          {tabsRow}
        </>
      )}
...
// ─── Tab entry-point ───────────────────────────────────────
const TabCustomerMerchants = ({ customer, openMerchantId: openIdProp, setOpenMerchantId: setOpenIdProp, maskOn }) => {
