...
const SEED_APPS = [
  // ── PEP · Newland MTMS client (first-party, mandatory baseline) ──
  // Pre-installed on every factory image. Always present in the factory-image
  // ISV payload — operators may switch its version but can never remove it.
  {
    id: 'app-pep',
    name: 'PEP',
    package: 'com.newland.pospp.mtms.client.n900',
    iconHue: '#2A6FDB',
    category: 'Payments',
    description: 'Newland MTMS client (PEP) — the terminal-management agent that registers the device with TOMS, reports health, and brokers OTA. Mandatory baseline on every factory image.',
    devices: ['N950', 'S90', 'S60', 'N750', 'N750P', 'X800'],
    orientations: ['portrait', 'landscape'],
    status: 'published',
    publishMode: 'public',
    publisherCustomerId: null,
    signer: 'Newland Payment Technology · SHA-256 a1:9f:3c:…',
    mandatoryBaseline: true,
    versions: [
      { id: 'pep-v-3-2-0', name: '3.2.0', code: 3200, size: '9.8 MB', uploadedAt: '2026-05-12T08:00:00Z', publishedAt: '2026-05-13T09:00:00Z', status: 'published', scan: 'clean', perms: 14, minSdk: 24, targetSdk: 34, current: true, reach: 0,
        notes: 'MTMS registration hardening; faster OTA handshake.' },
      { id: 'pep-v-3-1-4', name: '3.1.4', code: 3140, size: '9.6 MB', uploadedAt: '2026-04-10T08:00:00Z', publishedAt: '2026-04-11T09:00:00Z', status: 'published', scan: 'clean', perms: 14, minSdk: 24, targetSdk: 34, reach: 0,
        notes: 'Stability fixes for heartbeat under flaky cellular.' },
      { id: 'pep-v-3-1-0', name: '3.1.0', code: 3100, size: '9.5 MB', uploadedAt: '2026-03-05T08:00:00Z', publishedAt: '2026-03-06T09:00:00Z', status: 'published', scan: 'clean', perms: 13, minSdk: 24, targetSdk: 33, reach: 0,
        notes: 'Adds remote diagnostics channel.' },
    ],
  },
  ...
  // ── Northwind Commerce (c-001) — ISV+ISO ─────────────
  {
    ...
    versions: [
      ...
      { id: 'v-4-2-3', name: '4.2.3', code: 1427, size: '27.4 MB', uploadedAt: '2026-01-28T08:00:00Z', publishedAt: '2026-01-29T09:00:00Z', status: 'published', scan: 'clean', perms: 17, minSdk: 24, targetSdk: 33, reach: 9,
        notes: 'Receipt printer driver update for the S90.' },
      { id: 'v-4-2-2', name: '4.2.2', code: 1426, size: '27.3 MB', uploadedAt: '2026-01-10T08:00:00Z', publishedAt: '2026-01-12T09:00:00Z', status: 'published', scan: 'clean', perms: 17, minSdk: 24, targetSdk: 33, reach: 9,
        notes: 'Offline queue persistence fix after force-quit.' },
      { id: 'v-4-2-1', name: '4.2.1', code: 1425, size: '27.1 MB', uploadedAt: '2025-12-15T08:00:00Z', publishedAt: '2025-12-16T09:00:00Z', status: 'published', scan: 'clean', perms: 16, minSdk: 24, targetSdk: 33, reach: 8,
        notes: 'Holiday-season throughput tuning.' },
      { id: 'v-4-2-0', name: '4.2.0', code: 1424, size: '26.9 MB', uploadedAt: '2025-11-20T08:00:00Z', publishedAt: '2025-11-24T09:00:00Z', status: 'published', scan: 'cleanish', perms: 16, minSdk: 24, targetSdk: 33, reach: 8,
        notes: 'Adds configurable tip presets and surcharge rules.' },
      { id: 'v-4-1-2', name: '4.1.2', code: 1422, size: '26.6 MB', uploadedAt: '2025-10-22T08:00:00Z', publishedAt: '2025-10-23T09:00:00Z', status: 'published', scan: 'clean', perms: 15, minSdk: 24, targetSdk: 33, reach: 7,
        notes: 'Patch: EMV contactless timing on N950.' },
      { id: 'v-4-1-1', name: '4.1.1', code: 1421, size: '26.4 MB', uploadedAt: '2025-09-24T08:00:00Z', publishedAt: '2025-09-25T09:00:00Z', status: 'published', scan: 'clean', perms: 15, minSdk: 24, targetSdk: 33, reach: 7,
        notes: 'Stability fixes for the receipt queue.' },
      { id: 'v-4-1-0', name: '4.1.0', code: 1420, size: '26.1 MB', uploadedAt: '2025-08-27T08:00:00Z', publishedAt: '2025-08-29T09:00:00Z', status: 'published', scan: 'cleanish', perms: 15, minSdk: 24, targetSdk: 33, reach: 6,
        notes: 'Adds partial refunds and split-tender groundwork.' },
    ],
    // Explicit subscriber roster (12) so the Subscribers tab exercises the
    // Load more pattern. Mix of contract kinds — we no longer gate this
    // list to ISO-only customers.
    subscriberCustomerIds: ['c-002','c-003','c-004','c-005','c-006','c-007','c-008','c-009','c-010','c-011','c-012','c-013'],
  },
  {
    id: 'app-stockroom',
    name: 'Stockroom',
