                        ...
                        <div className="cart-row__img">
                          {img
                            ...
                            : product.type === 'DEVICE' && model
                              ...
                              : <window.CompanyLogo name={product.name} size={56}/>}
                        </div>
...
// ─── Styles ────────────────────────────────────────────────────
const cartStyles = `
.cart-trigger { display: inline-flex; align-items: center; gap: var(--space-2); height: var(--control-height-md); padding: 0 var(--control-padding-x-md); border-radius: var(--radius-md); background: var(--color-bg-2); border: var(--border-width-thin) solid var(--color-border-default); box-shadow: var(--shadow-1); cursor: pointer; font-family: var(--font-family-sans); font-weight: var(--font-weight-medium); font-size: var(--font-size-md); color: var(--color-text-primary); transition: background var(--duration-fast) var(--easing-standard), border-color var(--duration-fast) var(--easing-standard); }
.cart-trigger:hover { background: var(--color-bg-hover); border-color: var(--color-border-strong); }
.cart-trigger__lbl { font-weight: var(--font-weight-medium); }
.cart-trigger__count { display: inline-grid; place-items: center; min-width: 18px; height: 18px; padding: 0 5px; border-radius: 8px; background: var(--color-primary-700); color: #fff; font-size: 12px; font-weight: 600; font-variant-numeric: tabular-nums; }
.cart-trigger__sub { font-size: 12px; color: var(--color-text-tertiary); padding-left: 4px; border-left: 1px solid var(--color-border-subtle); margin-left: 2px; }
...
.cart-drawer__title { font-size: 18px; font-weight: 600; letter-spacing: -0.01em; }
...
.cart-empty__icon { display: inline-grid; place-items: center; width: 56px; height: 56px; border-radius: 12px; background: var(--color-bg-3); color: var(--color-text-tertiary); margin-bottom: 12px; }
.cart-empty__title { font-size: 14px; font-weight: 500; color: var(--color-text-primary); }
.cart-empty__sub { font-size: 12px; color: var(--color-text-tertiary); margin-top: 4px; }

.cart-group { padding: 8px 18px 4px; }
.cart-group__head { display: flex; align-items: center; gap: 8px; padding: 10px 0 6px; }
.cart-group__hint { font-size: 12px; color: var(--color-text-tertiary); }
...
.cart-row__name { display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 500; color: var(--color-text-primary); }
...
.cart-row__variant { font-size: 12px; color: var(--color-text-tertiary); margin-top: 2px; display: flex; align-items: flex-start; gap: 8px; flex-wrap: wrap; }
...
.cart-row__variant-edit { display: inline-flex; align-items: center; gap: 3px; padding: 1px 6px; border: 0; border-radius: 4px; background: transparent; color: var(--color-primary-700); font-size: 12px; font-weight: 500; cursor: pointer; font-family: inherit; }
...
.cart-row__variant-done { padding: 3px 12px; border: 0; background: transparent; color: var(--color-primary-700); font-size: 12px; font-weight: 600; cursor: pointer; font-family: inherit; border-radius: 4px; }
.cart-row__variant-done:hover { background: var(--color-primary-50); }
.cart-row__variant-chip { display: inline-flex; align-items: center; gap: 6px; padding: 4px 8px; border: 1px solid var(--color-border-default); background: var(--color-bg-2); border-radius: 999px; font-size: 12px; color: var(--color-text-primary); cursor: pointer; font-family: inherit; }
...
.cart-row__variant-chip-price { font-size: 10px; opacity: 0.8; }

/* Android-style PopupWindow anchored to the Change button ──── */
.cart-pop { position: fixed; z-index: 9200; background: var(--color-bg-1); border: 1px solid var(--color-border-default); border-radius: 8px; box-shadow: 0 12px 32px oklch(0% 0 0 / 0.25), 0 2px 6px oklch(0% 0 0 / 0.1); display: flex; flex-direction: column; overflow: hidden; animation: cartPopRise 140ms cubic-bezier(0.2, 0.7, 0.3, 1); }
...
.cart-pop__title { flex: 1; min-width: 0; font-size: 12px; font-weight: 600; color: var(--color-text-primary); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.cart-pop__close { width: 22px; height: 22px; border-radius: 4px; border: 0; background: transparent; color: var(--color-text-tertiary); cursor: pointer; display: grid; place-items: center; flex: none; }
...
.cart-pop__chip { display: inline-flex; align-items: center; gap: 6px; padding: 4px 10px; border: 1px solid var(--color-border-default); background: var(--color-bg-2); border-radius: 999px; font-size: 12px; color: var(--color-text-primary); cursor: pointer; font-family: inherit; transition: all var(--duration-fast); }
...
.cart-pop__chip-price { font-size: 10px; opacity: 0.8; font-variant-numeric: tabular-nums; }
...
.cart-pop__btn { padding: 7px 14px; border: 1px solid transparent; border-radius: 6px; font-size: 12px; font-weight: 600; cursor: pointer; font-family: inherit; transition: all var(--duration-fast); display: inline-flex; align-items: center; gap: 4px; }
...
.cart-qty-cap { font-size: 10px; font-weight: 500; padding: 2px 7px; border-radius: 999px; color: var(--color-warning-700); background: var(--color-warning-50, oklch(96% 0.04 80)); border: 1px solid color-mix(in oklab, var(--color-warning-700) 18%, transparent); line-height: 1.3; white-space: nowrap; }
...
.cart-qty-val { min-width: 22px; text-align: center; font-size: 12px; font-weight: 500; font-variant-numeric: tabular-nums; }
.cart-qty-input { width: auto; min-width: 30px; max-width: 80px; height: 22px; padding: 0 4px; border: 0; background: transparent; text-align: center; font-family: inherit; font-size: 12px; font-weight: 500; font-variant-numeric: tabular-nums; color: var(--color-text-primary); outline: none; border-radius: 3px; box-sizing: content-box; }
...
.cart-row__line { font-size: 14px; font-weight: 500; color: var(--color-text-primary); }
.cart-row__unit { font-size: 12px; color: var(--color-text-tertiary); margin-top: 2px; }
.cart-row__ovr { color: var(--color-warning-700); }
.cart-row__remove { background: transparent; border: 0; color: var(--color-text-tertiary); cursor: pointer; font-size: 12px; padding: 4px 0 0; text-decoration: underline; font-family: inherit; }
.cart-row__remove:hover { color: var(--color-error-700); }

.cart-subtotal { display: flex; justify-content: space-between; align-items: baseline; font-size: 14px; font-weight: 600; }
.cart-fulfill-preview { background: var(--color-bg-3); border-radius: 8px; padding: 10px 12px; font-size: 12px; color: var(--color-text-secondary); line-height: 1.6; }
.cart-fulfill-preview__lbl { font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em; color: var(--color-text-tertiary); margin-bottom: 4px; }
.cart-cloud-hint { display: inline-flex; align-items: center; gap: 4px; font-size: 10px; color: var(--color-text-tertiary); align-self: flex-end; }
