  ...
  return (
    <div className="page">
      ...
      <div className="tkt-kpi" style={{ padding: 0, marginBottom: 16 }}>
        <button
          className={`tkt-kpi__tile ${!hasFilters ? 'is-on' : ''}`}
          onClick={clearAll}
        >
        ...
        <button
          className={`tkt-kpi__tile ${applied.os === 'ANDROID' ? 'is-on' : ''}`}
          onClick={() => toggleOsKpi('ANDROID')}
        >
        ...
        <button
          className={`tkt-kpi__tile ${applied.os === 'LINUX' ? 'is-on' : ''}`}
          onClick={() => toggleOsKpi('LINUX')}
        >
        ...
        <button
          className={`tkt-kpi__tile ${applied.os === 'RTOS' ? 'is-on' : ''}`}
          onClick={() => toggleOsKpi('RTOS')}
        >
