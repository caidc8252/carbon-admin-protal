...
const TICKET_TYPE = {
  "Payment Failure": { label: "Payment Failure", icon: "creditcard", hue: 25,
    bg: "color-mix(in oklab, var(--color-error-500) 12%, transparent)",
    fg: "var(--color-error-700)" },
  "Network Issue": { label: "Network Issue", icon: "link", hue: 70,
    bg: "var(--color-warning-50)",
    fg: "var(--color-warning-700)" },
  "Hardware": { label: "Hardware", icon: "device", hue: 280,
    bg: "oklch(94% 0.03 280)",
    fg: "oklch(40% 0.18 280)" },
  "App Crash": { label: "App Crash", icon: "alert", hue: 40,
    bg: "oklch(95% 0.04 40)",
    fg: "oklch(46% 0.16 40)" },
  "Security Alert": { label: "Security Alert", icon: "shield", hue: 12,
    bg: "oklch(95% 0.04 12)",
    fg: "oklch(46% 0.18 12)" },
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100%" }}>
      ...
      <div style={{ background: "var(--color-bg-1)" }}>
        {/* Sticky filter band — pins to top of the scroll region (搜索栏置顶) */}
        <div style={{
        ...
        <div className="sb__row" onKeyDown={(e) => { if (e.key === "Enter") runSearch(); }}
          ...
          <button type="button" onClick={() => setAdvOpen((o) => !o)}
            ...
            <window.Ico name="filter" size={13} />
            Advanced
            {advAppliedCount > 0 &&
        ...
        {/* Advanced filters — right-side drawer (unified with Devices · Option 2) */}
        {advOpen &&
        <>
        <div onClick={() => setAdvOpen(false)}
          style={{ position: "fixed", inset: 0, background: "var(--color-bg-overlay)", zIndex: 8000, animation: "fadeIn 120ms ease" }} />
        <section onKeyDown={(e) => { if (e.key === "Enter") runSearchAndClose(); }}
          style={{
            position: "fixed", top: 0, right: 0, bottom: 0, width: "min(560px, 94vw)", zIndex: 8001,
            background: "var(--bg2)", borderLeft: "1px solid var(--border-2)", boxShadow: "var(--shadow-4)",
            display: "flex", flexDirection: "column", overflow: "hidden"
          }}>
            <window.PanelHeader
              icon="filter"
              title="Advanced filters"
              description="Side drawer · all filters AND · click Apply & Search to apply · closing keeps the draft"
              onClose={() => setAdvOpen(false)} closeTitle="Close (Esc)" />
            ...
            <div style={{
              ...
              <button type="button" onClick={resetAdvanced}
                ...
                style={{
                  ...
                  color: "var(--fg2)", fontFamily: "inherit", fontSize: 14, fontWeight: 500,
              ...
              <div style={{ flex: 1 }} />
              <button type="button" className="sb__cta" onClick={runSearchAndClose}>
                <window.Ico name="search" size={13} />
                Apply &amp; Search
              </button>
            </div>
        ...
        {/* Active filters — only takes vertical space when filters are applied
            (avoids a phantom gap so search→table stays the standard 16px) */}
        <div style={{ padding: hasFilters ? "var(--space-3) var(--space-6) 0" : "0 var(--space-6)" }}>
        ...
        <div style={{ padding: "var(--space-4) var(--space-6) var(--space-6)" }}>
          <div style={{ background: "var(--bg2)", border: "1px solid var(--border-2)",
            ...
            <div className="table-wrap">
              ...
              `}</style>
              <table className="tk-list-table" style={{ width: "100%", borderCollapse: "collapse", fontSize: 14, tableLayout: "fixed" }}>
                <colgroup>
                    ...
                    return (
                      ...
                      onMouseLeave={(e) => e.currentTarget.style.background = "transparent"}>
                        <td style={{ padding: 0, overflow: "hidden" }}>
                          <div style={{ display: "flex", padding: "12px 14px 12px 0", minWidth: 0 }}>
                            <div style={{ display: "flex", flexDirection: "column", gap: 4, minWidth: 0 }}>
                              <div style={{
                                fontSize: 14, fontWeight: 600, color: "var(--fg1)", lineHeight: 1.3,
                              ...
                              <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", minWidth: 0 }}>
                                <span title={t.source === "auto" ? "Auto (cloud)" : "Manual (ISO)"} style={{
                                  ...
                                  background: t.source === "auto" ? "var(--color-info-50)" : "var(--bg3)",
                                  color: t.source === "auto" ? "var(--color-info-700)" : "var(--fg2)",
                                  border: "1px solid var(--border-1)"
                                }}>
                                  <window.Ico name={t.source === "auto" ? "bolt" : "edit"} size={10} stroke={1.8} />
                                </span>
                                <span className="mono" style={{ fontSize: 12, fontWeight: 500, color: "var(--fg2)" }}>{t.id}</span>
...
function tkPagerNum(active) {
  return {
    ...
    borderRadius: 10, border: "1px solid " + (active ? "var(--color-primary-600)" : "var(--color-border-default)"),
      ...
      <div style={{ display: "grid",
        ...
        borderRadius: "var(--radius-md)"
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <span className="overline" style={{ fontSize: 10 }}>Start</span>
            <input type="datetime-local" value={customStart}
          onChange={(e) => onCustomStart(e.target.value)}
          style={faultTimeInput} />
          </label>
          <label style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <span className="overline" style={{ fontSize: 10 }}>End</span>
    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <span className="mono" style={{ fontSize: 14, fontWeight: 600, color: "var(--fg1)" }}>
            {device.sn}
          </span>
          <span className="mono" style={{ fontSize: 12, color: "var(--fg3)" }}>{device.model}</span>
...
function DPChip({ iconName, label, onClear }) {
  return (
    <span style={{
      ...
      border: "1px solid color-mix(in oklab, var(--color-primary-500) 32%, transparent)",
      borderRadius: 999,
      fontSize: 12, color: "var(--color-primary-700)",
      fontFamily: "var(--font-family-sans)",
      fontWeight: 500
    }}>
  ...
  return (
    ...
    style={{
      ...
      <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 2 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <span className="mono" style={{ fontSize: 12, fontWeight: 500, color: "var(--fg1)" }} data-comment-anchor="2d8501e5f1-span-1524-11">
...
function DPEmpty({ title, hint }) {
  return (
    <div style={{ padding: "32px 18px", textAlign: "center" }}>
      <div style={{ fontSize: 12, color: "var(--fg2)", marginBottom: 6,
        textWrap: "pretty" }}>{title}</div>
      {hint && <div style={{ fontSize: 12, color: "var(--fg3)",
          ...
          <window.Card padding={20}>
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{
                ...
                borderRadius: "var(--radius-md)",
                fontSize: 12, color: "var(--fg3)", lineHeight: 1.55
              }}>
...
function TicketDetailScreen({ ticket, navigate }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      {/* ─── Header (standard detail band) ─── */}
      <div className="det-band">
      <div className="det-band__inner">
        <div className="det-header">
          <button className="det-back" onClick={() => navigate({ screen: "tickets" })}
            aria-label="Back to tickets" title="Back to tickets">
            <window.Ico name="chevL" size={16} />
          </button>
          <div className="det-header__logo" style={{ background: sv.tone === "error" ? "var(--color-error-500)" : sv.tone === "warn" ? "var(--color-warning-500)" : "var(--color-primary-700)" }}>
            <window.Ico name="alert" size={24} />
          </div>
          <div className="det-header__main">
            <h1 className="det-header__title">
              <span className="det-header__name">{ticket.title}</span>
            ...
            <div className="det-header__meta">
              ...
              <span>On{" "}
                ...
                className="mono"
                style={{ color: "var(--color-primary-700)", textDecoration: "underline", textUnderlineOffset: 2 }}>
                  {ticket.deviceSn}
                </a>
              </span>
              {device && <span>{device.model}</span>}
              {merchant && <span>{merchant.name}</span>}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginLeft: "auto", alignItems: "flex-end" }}>
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
              ...
              {(role === "ISO" && ["iso-working", "npt-resolved"].includes(ticket.status) ||
              role === "NPT" && ticket.status === "npt-working" && ticket.nptHandler !== "TOMS NPT queue") &&
              <window.Button icon="users"
              onClick={() => setAssignOpen(true)}>
                  Assign
                </window.Button>
              }
              {transitions.map((tr) =>
              <window.Button key={tr.id}
            ...
            <div style={{ fontSize: 10, color: "var(--fg3)", display: "flex", alignItems: "center", gap: 6 }}>
        ...
        {/* Status stepper — sits at the band's bottom edge */}
      ...
      {/* ─── Body ─── */}
      <div style={{ flex: 1, overflow: "auto", padding: "24px 24px 36px", background: "var(--color-bg-1)" }}>
        <div style={{
          display: "grid",
          gridTemplateColumns: "minmax(0, 1fr) 320px",
          gap: 24,
          maxWidth: "none", margin: 0, width: "100%"
        }}>
          {/* Left main */}
...
function DescriptionCard({ ticket, onPreviewAttachment }) {
  return (
    ...
    "Logged by the ISO operator based on a customer report."}>
      <div style={{ fontSize: 14, lineHeight: 1.6, color: "var(--fg1)", textWrap: "pretty" }}>
        {ticket.description}
      </div>
...
function AttachmentChip({ attachment, onClick }) {
  ...
  attachment.kind === "screenshot" ? "var(--color-info-50)" :
  "var(--bg3)";
  return (
    ...
    onMouseLeave={(e) => e.currentTarget.style.borderColor = "var(--border-1)"}>
      ...
      <span className="mono" style={{ fontSize: 10, color: "var(--fg3)" }}>{attachment.size}</span>
  ...
  return (
    ...
    <span style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 14, fontWeight: 500, color: "var(--fg1)", lineHeight: 1.5, textWrap: "pretty" }}>
          {ai.summary}
        </div>
      </div>
      ...
      <ol style={{ margin: 0, paddingLeft: 0, listStyle: "none",
        ...
        <li key={i} style={{
          ...
          borderRadius: "var(--radius-md)"
            ...
            <span style={{ fontSize: 14, lineHeight: 1.55, color: "var(--fg1)", textWrap: "pretty" }}>{s}</span>
          </li>
        )}
      </ol>
      ...
      <div style={{
        ...
        <span className="overline" style={{ fontSize: 10 }}>Cited</span>
...
function DeviceSnapshotCard({ snapshot, device, onOpenDevice }) {
  if (!snapshot || !device) {
    return (
      <window.Card title="Device snapshot">
        <div style={{ padding: 14, fontSize: 12, color: "var(--fg3)" }}>
  ...
  return (
    ...
    <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
          <span className="overline" style={{ fontSize: 10 }}>captured</span>
          <span className="mono" style={{ fontSize: 12, color: "var(--fg2)" }}>{snapshot.capturedAt}</span>
      ...
      <div style={{ display: "grid",
        ...
        <SnapPanel label="Network" snap>
          ...
          <>
            ...
            <SnapRow label="Wi-Fi IP" value={<span className="mono" style={{ fontSize: 12 }}>{snapshot.network.wifi.ip}</span>} />
            }
            </>
          }
        ...
        <SnapPanel label="System" snap>
          ...
          <SnapRow label="Firmware" value={<span className="mono" style={{ fontSize: 12 }}>{snapshot.firmware}</span>} />
        </SnapPanel>
      </div>
          ...
          {snapshot.recentEvents.map((e, i) => {
            ...
            return (
              <li key={i} style={{
                ...
                <span className="mono" style={{ fontSize: 10, color: "var(--fg3)", minWidth: 56 }}>{e.at}</span>
                <span style={{
...
function SnapRow({ label, value }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 5, minWidth: 0 }}>
      ...
      <span style={{ fontSize: 13, color: "var(--fg1)", minWidth: 0, wordBreak: "break-word" }}>{value}</span>
    </div>);
...
function SnapMeter({ label, value, pct, tone }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
      <span style={{ fontSize: 12, color: "var(--fg3)" }}>{label}</span>
      <span className="mono" style={{ fontSize: 13, color: "var(--fg1)", fontWeight: 500 }}>{value}</span>
      <div style={{ marginTop: 4, height: 4, borderRadius: 999, background: "var(--color-bg-3)", overflow: "hidden" }}>
            ...
            <li key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "baseline", gap: 8, flexWrap: "wrap" }}>
                    <span style={{ fontSize: 12, fontWeight: 500, color: "var(--fg1)" }}>{c.actor}</span>
                    <span style={{
                    fontSize: 10, fontWeight: 600, padding: "1px 5px", borderRadius: 3,
                    background: isNpt ? "oklch(95% 0.04 12)" : "oklch(94% 0.03 152)",
                    color: isNpt ? "oklch(46% 0.18 12)" : "var(--color-success-700)",
                    ...
                    <span className="mono" style={{ fontSize: 10, color: "var(--fg3)" }}>{c.at}</span>
                  </div>
                  <div style={{
  ...
  if (!device) {
    return (
      <window.Card title="Linked device">
        <div style={{ padding: 14, fontSize: 12, color: "var(--fg3)" }}>Device not found in fleet.</div>
      </window.Card>);
      ...
      <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            <div className="mono" style={{ fontSize: 12, color: "var(--fg3)" }}>{device.model}</div>
          </div>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 5,
            fontSize: 12, color: isOnline ? "var(--color-success-700)" : "var(--fg3)" }}>
            <span style={{ width: 7, height: 7, borderRadius: "50%",
              background: isOnline ? "var(--success)" : "var(--border-2)" }} />
            {isOnline ? "Online" : "Offline"}
          </span>
...
function MetaCard({ ticket }) {
  ...
  return (
    <window.Card title="Ticket info">
      ...
      <div style={{
        display: "flex", alignItems: "center", gap: 10,
        padding: "10px 12px", marginBottom: showNpt ? 8 : 12,
  ...
  return (
    ...
    hint={<>Scopes ISO authorized for NPT. <span className="mono">{grantedCount}</span> of <span className="mono">{items.length}</span> granted.</>}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", gap: 8,
        fontSize: 10, color: "var(--fg3)", marginTop: 5 }}>
        <span>At</span>
...
function Kv({ label, value }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 3, minWidth: 0 }}>
      <span className="overline" style={{ fontSize: 10 }}>{label}</span>
      <span style={{ color: "var(--fg1)", minWidth: 0, fontSize: 13 }}>{value}</span>
    </div>);
...
function TypeChip({ type, compact }) {
  ...
  const hued = t.hue != null;
  return (
    <span className={hued ? "tk-typechip" : ""} style={{
      display: "inline-flex", alignItems: "center", gap: 5,
      padding: compact ? "2px 8px" : "3px 9px",
      borderRadius: 999,
      ...(hued ? { "--tk-h": t.hue } : { background: t.bg, color: t.fg }),
...
function SourceChip({ source }) {
  ...
  return (
    <span style={{
      ...
      background: isAuto ? "var(--color-info-50)" : "var(--bg3)",
      color: isAuto ? "var(--color-info-700)" : "var(--fg2)",
      border: "1px solid var(--border-1)",
      fontSize: 11, fontWeight: 500,
      whiteSpace: "nowrap"
    }}>
      <window.Ico name={isAuto ? "bolt" : "edit"} size={11} stroke={1.8} />
      {isAuto ? "Auto" : "Manual"}
    </span>);
      ...
      <div role="listbox" style={{
        ...
        minWidth: 220, zIndex: 100, padding: 4
          ...
          marginBottom: 4
            ...
            <span className="overline" style={{ fontSize: 10 }}>Filter status</span>
...
const linkBtn = {
  ...
  fontSize: 10, color: "var(--color-primary-700)", cursor: "pointer",
...
function EscalateDialog({ open, ticket, device, snapshot, onClose, onConfirm }) {
  ...
  return (
    ...
    footer={
    <>
          <span style={{ marginRight: "auto", fontSize: 12, color: "var(--fg3)" }}>
      ...
      <div style={{
        ...
        borderRadius: "var(--radius-md)",
        fontSize: 12, color: "var(--fg2)", lineHeight: 1.55,
        display: "flex", gap: 8
      }}>
...
function GrantRow({ id, checked, onToggle, info }) {
  ...
  return (
    <label htmlFor={`grant-${id}`} style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <span style={{ fontSize: 14, fontWeight: 500, color: "var(--fg1)" }}>{info.label}</span>
          <span style={{
        ...
        <div style={{ marginTop: 4, fontSize: 12, color: "var(--fg3)", lineHeight: 1.5 }}>{info.detail}</div>
      </div>
    </label>);
          ...
          return (
            ...
            onMouseLeave={(e) => {if (!on) e.currentTarget.style.background = "transparent";}}>
              ...
              <span style={{ minWidth: 0 }}>
                ...
                <div style={{ fontSize: 12, color: "var(--fg3)", marginTop: 1, textWrap: "pretty" }}>
                  {r.sub}
                </div>
              </span>
              {on &&
...
function AttachmentPreviewModal({ attachment, ticket, onClose }) {
  ...
  return (
    ...
    <span style={{ display: "inline-flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        ...
        background: isLog ? "var(--bg3)" : "var(--color-info-50)",
        color: isLog ? "var(--fg2)" : "var(--color-info-700)",
        letterSpacing: "0.05em", textTransform: "uppercase",
        fontFamily: "var(--font-mono)"
    ...
    padding={isShot ? "var(--space-6)" : 0}>
      ...
      {!isLog && !isShot &&
      <div style={{ padding: 30, textAlign: "center", color: "var(--fg3)", fontSize: 14 }}>
          ...
          {["I", "W", "E"].map((l) => {
            ...
            return (
              ...
              style={{
                ...
                borderRadius: "var(--radius-sm)",
                fontFamily: "var(--font-family-mono)", fontSize: 10, fontWeight: 600,
      ...
      <div ref={bodyRef} style={{
        ...
        <div style={{
          ...
          style={{ color: "oklch(40% 0.02 240)" }} />
            ...
            {query &&
          <div style={{ fontSize: 12, color: "oklch(48% 0.02 240)" }}>
