...
const SEED_ORDERS = [
  // 1) Awaiting payment — has discount but still non-zero
  {
    ...
    items: [
      { id: 'li-1', productId: 'p-001', productNameSnapshot: 'N950 Sample', sku: 'PRD-N950-S', modelId: 'm-n950', modelName: 'N950 Sample', unitPrice: 459, qty: 12, type: 'Semi-integration', devices: emptyDevices(12) },
      { id: 'li-2', productId: 'p-014', productNameSnapshot: 'S30 Sample',  sku: 'PRD-P-014',  modelId: 'm-s30',  modelName: 'S30 Sample',  unitPrice: 289, qty: 8, type: 'Stand-alone', devices: emptyDevices(8) },
    ],
    discountPct: 5,
  ...
  // 2) Awaiting shipment — no payment needed (fully discounted)
  {
    ...
    items: [
      { id: 'li-1', productId: 'p-013', productNameSnapshot: 'N750 Sample', sku: 'PRD-P-013', modelId: 'm-n750', modelName: 'N750 Sample', unitPrice: 349, qty: 4, type: 'Stand-alone',     devices: emptyDevices(4) },
      { id: 'li-2', productId: 'p-016', productNameSnapshot: 'S60 Sample',  sku: 'PRD-P-016', modelId: 'm-s60',  modelName: 'S60 Sample',  unitPrice: 549, qty: 2, type: 'Semi-integration', devices: emptyDevices(2) },
    ],
    discountPct: 100,
  ...
  // 3) Awaiting shipment — paid + activation codes partially entered
  {
    ...
    items: [
      {
        id: 'li-1', productId: 'p-014', productNameSnapshot: 'S30 Sample', sku: 'PRD-P-014', modelId: 'm-s30', modelName: 'S30 Sample', unitPrice: 289, qty: 6, type: 'Stand-alone',
        devices: [
          ...populatedDevices(4, 'S30', 41201),
          ...emptyDevices(2),
        ],
      },
    ],
    ...
    events: [
      ...
      { at: '2026-05-06T10:14:00Z', kind: 'activate',by: 'warehouse@carbon', text: '4 of 6 S30 Sample devices activated and recorded' },
    ],
  },
  ...
  // 4) Shipped — all activation done
  {
    ...
    status: 'Shipped',
    items: [
      { id: 'li-1', productId: 'p-016', productNameSnapshot: 'S60 Sample', sku: 'PRD-P-016', modelId: 'm-s60', modelName: 'S60 Sample', unitPrice: 549, qty: 3, type: 'Semi-integration', devices: populatedDevices(3, 'S60', 22018) },
    ],
    discountPct: 0,
  ...
  // 5) Partially complete — multi-model, some shipped, some pending
  {
    ...
    items: [
      { id: 'li-1', productId: 'p-013', productNameSnapshot: 'N750 Sample', sku: 'PRD-P-013', modelId: 'm-n750', modelName: 'N750 Sample', unitPrice: 349, qty: 5, type: 'Stand-alone',     devices: populatedDevices(5, 'N75', 90112), shipped: true },
      { id: 'li-2', productId: 'p-015', productNameSnapshot: 'X800 Sample', sku: 'PRD-P-015', modelId: 'm-x800', modelName: 'X800 Sample', unitPrice: 999, qty: 2, type: 'Semi-integration', devices: emptyDevices(2), shipped: false },
    ],
    discountPct: 0,
    ...
    events: [
      ...
      { at: '2026-04-15T09:20:00Z', kind: 'ship',     by: 'warehouse@carbon', text: 'Partial shipment · 5× N750 Sample dispatched' },
    ],
  },
  ...
  // 6) Complete
  {
    ...
    status: 'Complete',
    items: [
      { id: 'li-1', productId: 'p-014', productNameSnapshot: 'S30 Sample', sku: 'PRD-P-014', modelId: 'm-s30', modelName: 'S30 Sample', unitPrice: 289, qty: 24, type: 'Stand-alone', devices: populatedDevices(24, 'S30', 38001) },
    ],
    discountPct: 8,
