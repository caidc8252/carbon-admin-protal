  ...
  if (clause.type === 'feature') {
    ...
    return (
      <div style={{
        ...
        <label style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 14, cursor: disabled ? 'not-allowed' : 'pointer' }}>
          <input
            type="checkbox"
            checked={flat.enable}
            disabled={disabled}
...
.cf-models__placeholder { color: var(--color-text-tertiary); font-size: 14px; flex: 1; }
...
.cf-models__opt-name { font-size: 14px; font-weight: 500; }
