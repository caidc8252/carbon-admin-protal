        ...
        <div className="fw-mbc__body">
          ...
          <div className="fw-mbc__section">
            <div className="fw-mbc__section-head">
              <span>Firmware</span>
              {fwForModel.length === 0 && (
                <span className="muted" style={{ fontSize: 11.5, fontWeight: 400 }}>No firmware available</span>
              )}
            </div>
            {fwForModel.length === 0 ? (
                  ...
                  <div key={app.id} className={`fw-app-card ${currentRef ? 'is-on' : ''}`}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 10px' }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div className="muted" style={{ fontSize: 11, fontFamily: 'var(--font-family-mono)' }}>{app.package || app.pkg}</div>
                      </div>
                    </label>
