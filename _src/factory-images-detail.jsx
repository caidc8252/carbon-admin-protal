...
const FiHeaderCard = ({ factoryImage, onOpenCustomer, onEdit }) => {
  ...
  return (
    <div className="info-card fi-head" style={{ padding: 20, marginBottom: 14 }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {/* Meta row */}
          <div style={{ marginTop: 12, display: 'flex', flexWrap: 'wrap', rowGap: 8, columnGap: 20, fontSize: 12.5, color: 'var(--color-text-secondary)' }}>
            {/* Bound ISO — clickable */}
            {iso ? (
              <button type="button"
                ...
                <span style={{ fontSize: 11, color: 'var(--color-text-tertiary)', fontWeight: 600, letterSpacing: '0.04em' }}>ISO</span>
              ...
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                <span style={{ fontSize: 11, color: 'var(--color-text-tertiary)', fontWeight: 600 }}>ISO</span>
          ...
          <div style={{ marginTop: 10, paddingTop: 10, borderTop: '1px solid var(--color-border-subtle)', display: 'flex', flexWrap: 'wrap', rowGap: 6, columnGap: 22, fontSize: 12, color: 'var(--color-text-tertiary)' }}>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
