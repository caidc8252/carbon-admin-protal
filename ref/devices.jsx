        ...
        <window.Card title="Deployment">
          <KvTable rows={[
            ...
            ["Address",   store?.address
                ...
                : <Dash />],
            ["Last seen", <span className="mono" style={{ fontSize: 13 }}>{device.lastSeenAt}</span>],
          ]} />
        </window.Card>
      ...
      <div className="device-basic__row-2">
        <window.Card title="System">
          <KvTable rows={[
            ...
            ["Build",          <span className="mono" style={{ fontSize: 13 }}>{device.buildNumber}</span>],
    ...
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, minWidth: 0 }}>
        ...
        <Tile label="Coordinates"
          ...
          sub={`±${(8 + Math.abs(seed % 12)).toFixed(0)} m accuracy`} />
...
function InterfaceRow({ label, icon, on, primary, ip, signalDbm, badges = [] }) {
  ...
  return (
    <div style={{
      ...
      borderRadius: "var(--radius-md)",
      display: "grid",
      gridTemplateColumns: "32px minmax(120px, 1fr) auto",
