...
const UIcon = ({ name, size = 16 }) => {
  ...
  const paths = {
    ...
    external:   <g {...s}><path d="M14 4h6v6M20 4l-9 9" /><path d="M18 13v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h5" /></g>,
...
const UserMenu = ({
  ...
  user, theme, lang,
  onTheme, onLang,
  onGoProfile, onGoAccount, onGoWorkspaces, onGoActivity, onGoHelp,
  onSignOut })=>
{
      ...
      <div className={`um-views um-views--${view}`}>
        ...
        <div className="um-view">
          <div className="um-head">
            <div className="um-head__avatar" style={user.avatarColor ? { background: user.avatarColor } : undefined}>
          ...
          <div className="um-section">
            ...
            <Row icon="building" label="Switch partner" onClick={() => {onGoWorkspaces();onClose();}} trailing={<UIcon name="chevR" size={12} />} />
          </div>
